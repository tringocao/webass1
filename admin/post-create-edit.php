      ...
      <div class="col-12 col-md-9 py-4" id="main">
        ...
        <div class="row mb-3">
          ...
          <div class="col-12 col-md-10">
            <input type="text" class="form-control" placeholder="Tiêu đề chính" value="10 thắng cảnh du lịch hấp dẫn nhất Việt Nam"> 
          </div>
        </div>
        <div class="row mb-3">
          <div class="col-12 col-md-2">
          ...
          <div class="col-12 col-md-10">
            <input type="text" class="form-control" placeholder="Tiêu đề phụ" value="VietNam"> 
          </div>
        </div>
        <div class="row mb-3">
          <div class="col-12 col-md-2">
