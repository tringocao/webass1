      ...
      <div class="col-12 col-md-9 py-4" id="main">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">pika</li>
          </ol>
        </nav>
        <div class="row mb-3 flex-center">
          ...
          <div class="col-12 col-md-10">
            <input type="text" class="form-control" value="pika">
          </div>
        </div>
        <div class="row mb-3 flex-center">
          <div class="col-12 col-md-2">
          ...
          <div class="col-12 col-md-10">
            <input type="radio" checked> <span class="ml-2">Nam</span>
            <input type="radio"> <span class="ml-2">Nữ</span>
          </div>
        </div>
        <div class="row mb-3 flex-center">
          <div class="col-12 col-md-2">
